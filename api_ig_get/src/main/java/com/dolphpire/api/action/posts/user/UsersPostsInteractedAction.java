...
public class UsersPostsInteractedAction {
    ...
    public void execute() {
        StringRequest strReq = new StringRequest(Request.Method.POST,
                EndPoints.POSTS_USER_INTERACTED, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!responseObj.getBoolean("error")) {
                        JSONArray usersDataJSON = responseObj.getJSONObject("interactedPosts").getJSONArray("posts");
    ...
    public UsersPostsInteractedAction addOnCompleteListener(ZFlowPostsCallback.OnCompleteListener<ZeoFlowPost> onCompleteListener) {

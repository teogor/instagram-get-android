...
public class UserConnectionAction {
    ...
    public UserConnectionAction addOnCompleteListener(ZFlowQUsersCallback.OnCompleteListener<ZeoFlowQuickUser> onCompleteListener) {

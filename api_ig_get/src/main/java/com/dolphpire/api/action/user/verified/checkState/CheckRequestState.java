...
public class CheckRequestState {
    ...
    public CheckRequestState addOnFailureListener(ZFlowFailureCallback.OnFailureListener onFailureListener) {
        this.onFailureListener = onFailureListener;
        return this;
    }

    public CheckRequestState addOnFailedListener(ZFlowApiCallback.ApiKeyError mApiKeyError) {

...
public class UpdateFeaturedProfiles {
    ...
    public void execute() {
        StringRequest strReq = new StringRequest(Request.Method.POST,
                EndPoints.USER_FEATURED_PROFILES_UPDATE, new Response.Listener<String>() {
    ...
    public UpdateFeaturedProfiles addOnCompleteListener(DPireOnCompleteCallback.OnComplete onComplete) {
    ...
    void setList(String featuredProfiles) {

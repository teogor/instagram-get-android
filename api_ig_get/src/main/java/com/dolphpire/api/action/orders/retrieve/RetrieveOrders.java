...
//            Log.e(TAG, "response: " + response);
    ...
    public RetrieveOrders addOnCompleteListener(OnOrdersRetrieved.OnCompleteListener<OrderModel> onComplete)
    {
        this.onComplete = onComplete;
        return this;
    }

    public RetrieveOrders addOnFailureListener(FailureCallback.OnFailureListener onFailureListener)
    {
        this.onFailureListener = onFailureListener;
        return this;
    }

    public RetrieveOrders addOnFailedListener(ApiCallback.ApiKeyError mApiKeyError)
    {

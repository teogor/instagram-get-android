...
public class SearchClicked {
    ...
    public void execute() {
        StringRequest strReq = new StringRequest(Request.Method.POST,
                EndPoints.DISCOVER_SEARCH_CLICKED, new Response.Listener<String>() {
...
//                Log.e(TAG, "response: " + response);
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("type", type == -1 ? "-1" : String.valueOf(type));
                params.put("id", id == -1 ? "-1" : String.valueOf(id));
                return params;
            }
        };
    ...
    public SearchClicked addOnCompleteListener(ZFlowOnCompleteCallback.OnComplete onCompleteListener) {
        this.onCompleteListener = onCompleteListener;
        return this;
    }

    public SearchClicked addOnFailureListener(ZFlowFailureCallback.OnFailureListener onFailureListener) {
        this.onFailureListener = onFailureListener;
        return this;
    }

    public SearchClicked addOnFailedListener(ZFlowApiCallback.ApiKeyError mApiKeyError) {

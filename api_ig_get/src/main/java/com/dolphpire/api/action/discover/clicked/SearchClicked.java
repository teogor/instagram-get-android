...
//                Log.e(TAG, "response: " + response);
    ...
    public SearchClicked addOnFailureListener(FailureCallback.OnFailureListener onFailureListener) {
        this.onFailureListener = onFailureListener;
        return this;
    }

    public SearchClicked addOnFailedListener(ApiCallback.ApiKeyError mApiKeyError) {

...
public class UpdateAction {
    ...
    public UpdateAction addOnFailureListener(FailureCallback.OnFailureListener onFailureListener) {
        this.onFailureListener = onFailureListener;
        return this;
    }

    public UpdateAction addOnFailedListener(ApiCallback.ApiKeyError mApiKeyError) {

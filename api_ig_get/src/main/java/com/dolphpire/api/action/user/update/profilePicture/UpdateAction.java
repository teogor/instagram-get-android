...
public class UpdateAction {
    ...
    UpdateAction(String image_id) {
        this.image_id = String.valueOf(image_id);
    }

    public void execute() {
        StringRequest strReq = new StringRequest(Request.Method.POST,
                EndPoints.USER_PROFILE_PICTURES_UPDATE, new Response.Listener<String>() {
    ...
    public UpdateAction addOnFailureListener(ZFlowFailureCallback.OnFailureListener onFailureListener) {
        this.onFailureListener = onFailureListener;
        return this;
    }

    public UpdateAction addOnFailedListener(ZFlowApiCallback.ApiKeyError mApiKeyError) {

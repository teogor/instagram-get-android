...
public class DeleteAction {
    ...
    DeleteAction(String image_id) {
        this.image_id = String.valueOf(image_id);
    }

    public void execute() {
        StringRequest strReq = new StringRequest(Request.Method.POST,
                EndPoints.USER_PROFILE_PICTURES_DELETE, new Response.Listener<String>() {
    ...
    public DeleteAction addOnCompleteListener(ZFlowOnCompleteCallback.OnComplete onComplete) {
        this.onComplete = onComplete;
        return this;
    }

    public DeleteAction addOnFailureListener(ZFlowFailureCallback.OnFailureListener onFailureListener) {
        this.onFailureListener = onFailureListener;
        return this;
    }

    public DeleteAction addOnFailedListener(ZFlowApiCallback.ApiKeyError mApiKeyError) {

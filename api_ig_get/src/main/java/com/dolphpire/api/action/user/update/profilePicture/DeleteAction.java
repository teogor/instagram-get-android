...
public class DeleteAction {
    ...
    public DeleteAction addOnCompleteListener(DPireOnCompleteCallback.OnComplete onComplete) {
        this.onComplete = onComplete;
        return this;
    }

    public DeleteAction addOnFailureListener(FailureCallback.OnFailureListener onFailureListener) {
        this.onFailureListener = onFailureListener;
        return this;
    }

    public DeleteAction addOnFailedListener(ApiCallback.ApiKeyError mApiKeyError) {

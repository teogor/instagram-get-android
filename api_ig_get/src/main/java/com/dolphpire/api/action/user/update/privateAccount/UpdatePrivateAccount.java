package com.dolphpire.api.action.user.update.privateAccount;
...
public class UpdatePrivateAccount {
    ...
    private int privateAccount = -1;

    public UpdatePrivateAccount(boolean makePrivate) {
        this.privateAccount = makePrivate ? 1 : 0;
    }

    public void execute() {
        StringRequest strReq = new StringRequest(Request.Method.POST,
                EndPoints.USER_PRIVATE_ACCOUNT_UPDATE, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("privateAccount", String.valueOf(privateAccount));
                return params;
            }
        };
    ...
    public UpdatePrivateAccount addOnCompleteListener(ZFlowOnCompleteCallback.OnComplete onComplete) {
        this.onComplete = onComplete;
        return this;
    }

    public UpdatePrivateAccount addOnFailureListener(ZFlowFailureCallback.OnFailureListener onFailureListener) {
        this.onFailureListener = onFailureListener;
        return this;
    }

    public UpdatePrivateAccount addOnFailedListener(ZFlowApiCallback.ApiKeyError mApiKeyError) {

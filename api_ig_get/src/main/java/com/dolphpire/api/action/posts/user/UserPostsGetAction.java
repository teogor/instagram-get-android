...
public class UserPostsGetAction {
    ...
    public void execute() {
        StringRequest strReq = new StringRequest(Request.Method.POST,
                EndPoints.POSTS_USER, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!responseObj.getBoolean("error")) {
                        JSONArray usersDataJSON = responseObj.getJSONObject("userPosts").getJSONArray("posts");
    ...
    public UserPostsGetAction addOnCompleteListener(ZFlowPostsCallback.OnCompleteListener<ZeoFlowPost> onCompleteListener) {

...
public class UsersPostsSavedAction {
    ...
    UsersPostsSavedAction() {

    }

    public void execute() {
        StringRequest strReq = new StringRequest(Request.Method.POST,
                EndPoints.POSTS_USER_SAVED, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!responseObj.getBoolean("error")) {
                        JSONArray usersDataJSON = responseObj.getJSONObject("savedPosts").getJSONArray("posts");
                        ...
                        } else if (errorData.getInt("errorType") == 113) {
    ...
    public UsersPostsSavedAction addOnCompleteListener(ZFlowPostsCallback.OnCompleteListener<ZeoFlowPost> onCompleteListener) {
        this.onCompleteListener = onCompleteListener;
        return this;
    }

    public UsersPostsSavedAction addOnFailureListener(ZFlowFailureCallback.OnFailureListener onFailureListener) {
        this.onFailureListener = onFailureListener;
        return this;
    }

    public UsersPostsSavedAction addOnFailedListener(ZFlowApiCallback.ApiKeyError mApiKeyError) {

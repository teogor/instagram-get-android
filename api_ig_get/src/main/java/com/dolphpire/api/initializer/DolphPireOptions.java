...
import static com.dolphpire.api.initializer.Preconditions.checkNotEmpty;
import static com.dolphpire.api.initializer.StringsVerify.isEmptyOrWhitespace;

/** Configurable ZeoFlow options. */
public final class DolphPireOptions {
  ...
  @Nullable
  @KeepForApi
  public static DolphPireOptions fromResource(@NonNull Context context) {
  ...
  public boolean equals(Object o) {
    if (!(o instanceof DolphPireOptions)) {
      return false;
    } else {
      DolphPireOptions other = (DolphPireOptions)o;
  ...
  public static final class Builder {
     ...
     */
    public Builder(@NonNull DolphPireOptions options) {

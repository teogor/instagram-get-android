...
public class DolphPireInitProvider extends ContentProvider {

    /**
     * Should match the {@link DolphPireInitProvider} authority if $androidId is empty.
     */
    @VisibleForTesting
    static final String EMPTY_APPLICATION_ID_PROVIDER_AUTHORITY =
            "com.zeoflow.api.zeoflowinitprovider";
